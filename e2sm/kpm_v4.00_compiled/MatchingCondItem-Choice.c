...
static asn_TYPE_member_t asn_MBR_MatchingCondItem_Choice_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MatchingCondItem_Choice, choice.measLabel),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MatchingCondItem_Choice, choice.testCondInfo),
...
static asn_CHOICE_specifics_t asn_SPC_MatchingCondItem_Choice_specs_1 = {
