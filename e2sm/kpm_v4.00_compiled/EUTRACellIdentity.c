...
int
EUTRACellIdentity_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
EUTRACellIdentity_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
EUTRACellIdentity_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	EUTRACellIdentity_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
EUTRACellIdentity_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
EUTRACellIdentity_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
EUTRACellIdentity_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
EUTRACellIdentity_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
EUTRACellIdentity_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_TYPE_descriptor_t asn_DEF_EUTRACellIdentity = {
	"EUTRACellIdentity",
	"EUTRACellIdentity",
	EUTRACellIdentity_free,
	EUTRACellIdentity_print,
	EUTRACellIdentity_constraint,
	EUTRACellIdentity_decode_ber,
	EUTRACellIdentity_encode_der,
	EUTRACellIdentity_decode_xer,
	EUTRACellIdentity_encode_xer,
