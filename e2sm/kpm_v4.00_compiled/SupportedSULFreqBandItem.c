...
static int
memb_freqBandIndicatorNr_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_TYPE_member_t asn_MBR_SupportedSULFreqBandItem_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_SupportedSULFreqBandItem_specs_1 = {
