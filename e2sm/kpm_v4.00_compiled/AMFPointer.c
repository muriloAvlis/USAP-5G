...
int
AMFPointer_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
AMFPointer_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
AMFPointer_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	AMFPointer_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
AMFPointer_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
AMFPointer_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
AMFPointer_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
AMFPointer_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
AMFPointer_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_TYPE_descriptor_t asn_DEF_AMFPointer = {
	...
	AMFPointer_decode_ber,
	AMFPointer_encode_der,
	AMFPointer_decode_xer,
	AMFPointer_encode_xer,
