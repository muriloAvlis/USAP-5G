...
static int
reportingPeriod_2_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
reportingPeriod_2_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
static void
reportingPeriod_2_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	reportingPeriod_2_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
reportingPeriod_2_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
reportingPeriod_2_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
reportingPeriod_2_encode_der(asn_TYPE_descriptor_t *td,
...
static asn_dec_rval_t
reportingPeriod_2_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
reportingPeriod_2_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static int
memb_reportingPeriod_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	unsigned long value;
...
asn_TYPE_descriptor_t asn_DEF_reportingPeriod_2 = {
	"reportingPeriod",
	"reportingPeriod",
	reportingPeriod_2_free,
	reportingPeriod_2_print,
	reportingPeriod_2_constraint,
	reportingPeriod_2_decode_ber,
	reportingPeriod_2_encode_der,
	reportingPeriod_2_decode_xer,
	reportingPeriod_2_encode_xer,
...
static asn_TYPE_member_t asn_MBR_E2SM_KPM_EventTriggerDefinition_Format1_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_E2SM_KPM_EventTriggerDefinition_Format1_specs_1 = {
