...
static int
incompleteFlag_3_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
incompleteFlag_3_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
static void
incompleteFlag_3_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	incompleteFlag_3_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
incompleteFlag_3_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
incompleteFlag_3_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
incompleteFlag_3_encode_der(asn_TYPE_descriptor_t *td,
...
static asn_dec_rval_t
incompleteFlag_3_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
incompleteFlag_3_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_TYPE_descriptor_t asn_DEF_incompleteFlag_3 = {
	"incompleteFlag",
	"incompleteFlag",
	incompleteFlag_3_free,
	incompleteFlag_3_print,
	incompleteFlag_3_constraint,
	incompleteFlag_3_decode_ber,
	incompleteFlag_3_encode_der,
	incompleteFlag_3_decode_xer,
	incompleteFlag_3_encode_xer,
...
static asn_TYPE_member_t asn_MBR_MeasurementDataItem_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_MeasurementDataItem_specs_1 = {
