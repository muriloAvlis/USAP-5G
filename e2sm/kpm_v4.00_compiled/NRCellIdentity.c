...
int
NRCellIdentity_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
NRCellIdentity_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
NRCellIdentity_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	NRCellIdentity_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
NRCellIdentity_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
NRCellIdentity_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
NRCellIdentity_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
NRCellIdentity_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
NRCellIdentity_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_TYPE_descriptor_t asn_DEF_NRCellIdentity = {
	...
	"NRCellIdentity",
	NRCellIdentity_free,
	NRCellIdentity_print,
	NRCellIdentity_constraint,
	NRCellIdentity_decode_ber,
	NRCellIdentity_encode_der,
	NRCellIdentity_decode_xer,
	NRCellIdentity_encode_xer,
