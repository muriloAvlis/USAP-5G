...
/* @@protoc_insertion_point(class_definition:xapp.KPMIndicationResponse) */ {
 ...
 public:
  ...
  enum : int {
    kUeFieldNumber = 2,
    kCollectStartTimeFieldNumber = 1,
  };
  // .xapp.UEInfos ue = 2;
  bool has_ue() const;
  void clear_ue() ;
  ...
  void clear_collectstarttime() ;
  ::uint64_t collectstarttime() const;
  void set_collectstarttime(::uint64_t value);

  private:
  ::uint64_t _internal_collectstarttime() const;
  void _internal_set_collectstarttime(::uint64_t value);
...
// uint64 collectStartTime = 1;
inline void KPMIndicationResponse::clear_collectstarttime() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.collectstarttime_ = ::uint64_t{0u};
}
inline ::uint64_t KPMIndicationResponse::collectstarttime() const {
  // @@protoc_insertion_point(field_get:xapp.KPMIndicationResponse.collectStartTime)
  return _internal_collectstarttime();
}
inline void KPMIndicationResponse::set_collectstarttime(::uint64_t value) {
  _internal_set_collectstarttime(value);
  // @@protoc_insertion_point(field_set:xapp.KPMIndicationResponse.collectStartTime)
}
inline ::uint64_t KPMIndicationResponse::_internal_collectstarttime() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.collectstarttime_;
}
inline void KPMIndicationResponse::_internal_set_collectstarttime(::uint64_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.collectstarttime_ = value;
}
